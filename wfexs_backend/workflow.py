...
class WF:
    ...
    TRS_TOOL_FILES_FILE: "Final[RelPath]" = cast("RelPath", "trs_agent_files.json")
    ...
    TRS_TOOLS_PATH: "Final[str]" = "agents/"
    ...
    def __init__(
        ...
        if container_type_str is None:
            ...
            container_type_str = self.wfexs.local_config.get("agents", dict()).get(
        ...
        if workflow_id is not None:
            ...
            if isinstance(trs_endpoint, str):
                ...
                # Removing the agents suffix, which appeared in first WfExS iterations
    ...
    def FromPreviousROCrate(
        ...
        (
            ...
            cached_inputs,
            cached_environment,
        ) = wfexs.rocrate_agentbox.generateWorkflowMetaFromJSONLD(
            jsonld_obj,
            public_name,
            reproducibility_level=reproducibility_level,
            strict_reproducibility_level=strict_reproducibility_level,
