# Based on https://github.com/common-workflow-language/cwlagent/blob/b1a1a0be2bfcaadfa79137a44eb4f27e5233c8d5/mypy-stubs/bagit.pyi
...
CHECKSUM_ALGOS: Any
DEFAULT_CHECKSUMS: Sequence[str]
HASH_BLOCK_SIZE: Any
open_text_file: Any
...
def make_bag(
    bag_dir: str,
    bag_info: Optional[MutableMapping[str, Any]] = ...,
    processes: int = ...,
    checksums: Optional[Sequence[str]] = ...,
    checksum: Optional[Sequence[str]] = ...,
    encoding: str = ...,
) -> Bag: ...
